...
**最終更新**: 2026-01-08 15:55
**直近Gitコミット**: 29fe943 fix: UserFormテーブル名・列名参照エラー修正

---

## 現在の状態

パワークエリを年間ファイル対応に改修完了。月別12ファイル分割運用を廃止し、年間1ファイル運用に移行。
...
- [x] パワークエリ年間ファイル対応（2026-01-08）
  - 不良集計ゾーン別ADOクエリ.pq: 月別2ファイル結合 → 年間1ファイル
  - ロット数量ADOクエリ.pq: 同上
  - MissingField.UseNull追加（スキーマキャッシュ問題対策）
